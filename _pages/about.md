...
title: About
permalink: /
# subtitle: Postdoctoral Fellow · Boston Children's Hospital/Harvard Medical School
...
contact_note: >-
  ...
  (<a href="mailto:tao.hong@childrens.harvard.edu">tao.hong@childrens.harvard.edu</a>
  /
  <a href="mailto:hong.tao@ieee.org">hong.tao@ieee.org</a>).
...
I am currently a Postdoctoral Fellow in the Department of Radiology at **Boston Children's Hospital**, affiliated with **Harvard Medical School**, working with Prof. [Xiaoqing Wang](https://scholar.google.com/citations?user=99FdJPgAAAAJ&hl=en). My research focuses on developing **computational methods for large-scale inverse problems and computational imaging**, with an emphasis on model-based and learning-based MRI reconstruction.
...
- **Physics + learning for computational imaging** — integrating physical models with data-driven approaches for reliable and efficient reconstruction
- **Biomedical & scientific imaging** — computational methods spanning MRI, photoacoustic, and optical imaging
 -->
<div class="research-bands">
  <a class="research-band" href="{{ '/research/' | relative_url }}#optimization">
    ...
    <p class="research-band-text">Exploiting mathematical structure for  large-scale computation.</p>
  </a>
  ...
  <a class="research-band" href="{{ '/research/' | relative_url }}#computational-imaging">
    ...
    <div class="research-band-title">Biomedical & Scientific Imaging</div>

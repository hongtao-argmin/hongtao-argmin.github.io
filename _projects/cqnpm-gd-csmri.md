...
description: Convergent complex quasi-Newton proximal methods for gradient-driven denoisers in compressed sensing MRI reconstruction
img: assets/img/CQNPM2025/SpiralBrainRecoIm.png
importance: 1
category: work
...
<div style="display: flex; gap: 0.5em; justify-content: center; background-color: #e5e5e8; padding: 1.5em; border-radius: 6px; max-width: 1300px; margin: 0 auto; margin-top: 2em;">
  ...
  <img src="{{ '/assets/img/CQNPM2025/BrainSpiralPSNR2025up.gif' | relative_url }}" width="600"/>

  <img src="{{ '/assets/img/CQNPM2025/BrainSpiralRecoIms2025.gif' | relative_url }}" width="600"/>
...
<img src="{{ '/assets/img/CQNPM2025/SpiralBrainPSNR.png' | relative_url }}" alt="Comparison of cost and PSNR versus iterationa and wall time on spiral brain image" style="width: 100%; margin-top: 1em; border-radius: 6px;">
...
<img src="{{ '/assets/img/CQNPM2025/SpiralBrainRecoIm.png' | relative_url }}" alt="Comparison of Reco. Images for various methods" style="width: 100%; margin-top: 2em; border-radius: 6px;">

<p style="text-align: center; font-size: 1.3em; color: #333;">Figure 2: Reconstructed Images.</p>


<img src="{{ '/assets/img/CQNPM2025/SpiralBrainConv.png' | relative_url }}" alt="Conv. Validation" style="width: 100%; margin-top: 2em; border-radius: 6px;">
...
<h2 style="margin-top: 0; font-size: 1em; text-align: left;">BibTeX citation</h2>
